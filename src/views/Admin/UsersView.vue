...
<template>
              ...
              <div class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-col items-center pb-10">
                  ...
                  <div class="flex mt-4 md:mt-6">
                    <a @click.prevent="ShowModalWs" :class="{'opacity-50':user.group=='Администратор','pointer-events-none': user.group=='Администратор'}" class="cursor-pointer inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Назначить на смену</a>
                  </div>
                </div>
              </div>
  ...
  <div id="modal" class="transition-all transition-discrete hidden fixed top-0 left-0 right-0 bottom-0 bg-black/50 flex flex-col flex justify-center items-center">
    <div class="bg-white w-full md:w-1/2 h-fit rounded-xl p-5 flex flex-col items-center">
      <button @click.prevent="CloseModal" class="self-end">Назад</button>
