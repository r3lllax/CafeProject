            ...
            <li class="w-full col-span-full md:col-span-6 lg:col-span-4" v-for="user of item.users">
              <div class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-col items-center pb-10">
                  ...
                  <span class="transition-all cursor-default mt-3 text-sm text-gray-100 dark:text-gray-400 bg-gray-400 py-1 px-4 rounded-full blur-sm hover:blur-none">{{ user.login }}</span>
