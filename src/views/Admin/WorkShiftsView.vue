...
<template>
  ...
  <div :class="{'hidden':!modal.OpenStatus}" class="fixed bg-black/50 top-0 bottom-0 left-0 right-0 z-50 flex justify-center items-center">
    <div class="w-full md:w-1/2 max-h-full flex justify-center flex-col items-center bg-white gap-2 overflow-y-auto p-5 rounded-none md:rounded-xl">
      ...
      <button @click.prevent="MakeWS" class="mt-5 cursor-pointer w-full items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit">Создать</button>
      <button @click.prevent="toggleModal" class="cursor-pointer w-full items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit">Назад</button>
